...
export default function GeneratePage() {
  ...
  return (
    <div>
      ...
      {!selectedId && !defsLoading && (
        <div className="flex h-48 items-center justify-center rounded-xl border-2 border-dashed border-gray-300 text-sm text-gray-400 dark:border-slate-700 dark:text-slate-500">
          Select a program above to configure and generate a plan
        </div>
      )}
    </div>
  );
